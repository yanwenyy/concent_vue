<template>
  <div style="position: relative">
    ...
    <el-button v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailform.season.flowStatus=='notpass'||detailform.season.flowStatus=='check')" @click="saveInfo('detailform','sub')" class="detailbutton detail-back-tab sub-btn">提交</el-button>
    ...
    <el-tabs type="border-card" >
      ...
      <el-tab-pane label="季报生产经营JB1表(境内)">
        <div class="detailBox">
          <el-form
            :inline="false"
            :model="detailform"
      ...
      <el-tab-pane label="季报房建完成JB2表(境内)">
        <div class="detailBox">
        <el-form
          :inline="false"
          :model="detailform"
          ...
          <div class="row-four">
            ...
            <el-form-item>
              <el-input
                :disabled="p.actpoint === 'look'||p.actpoint=='task'"
                clearable
                @input="Addsum(detailform.buildingJnDetailList,'JB2_00_convalue','convalue')"
            ...
            <el-form-item>
              <el-input
                :disabled="p.actpoint === 'look'||p.actpoint=='task'"
                clearable
                @input="Addsum(detailform.buildingJnDetailList,'JB2_00_comvalue','comvalue')"
            ...
            <el-form-item>
              <el-input
                :disabled="p.actpoint === 'look'||p.actpoint=='task'"
                clearable
                @input="Addsum(detailform.buildingJnDetailList,'JB2_00_value','value')"
            ...
            <div class="row-three">
              ...
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.terminal"/>
              </el-form-item>
              <el-form-item
                label="其中：女性(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.female"/>
              </el-form-item>
              <p  class="detail-title" style="overflow: hidden;margin-right:30px">
                <span>按人员类型分 </span>
              </p>
              ...
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.terstaff"/>
              </el-form-item>
              <el-form-item
                label="劳务派遣人员(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.terlabor"/>
              </el-form-item>
              <el-form-item
                label="其他从业人员(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.terother"/>
              </el-form-item>
              <p  class="detail-title" style="overflow: hidden;margin-right:30px">
                <span>从业人员平均人数(人): </span>
              </p>
              <el-form-item
                label="在岗职工(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.averstaff"/>
              </el-form-item>
              <el-form-item
                label="劳务派遣人员(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.averlabor"/>
              </el-form-item>
              <el-form-item
                label="其他从业人员(人):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.averother"/>
              </el-form-item>
            </div>
            <div class="row-three">
              <p  class="detail-title" style="overflow: hidden;margin-right:30px">
              ...
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.salary"/>
              </el-form-item>
              <el-form-item
                label="在岗职工(千元):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.salstaff"/>
              </el-form-item>
              <el-form-item
                label="劳务派遣人员(千元):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.sallabor"/>
              </el-form-item>
              <el-form-item
                label="其他从业人员(千元):"
              >
                <el-input
                  ...
                  v-model="detailform.salaryDetail.salother"/>
              </el-form-item>
            </div>
          </el-form>
        </div>
      </el-tab-pane>
      <el-tab-pane label="季报财务状况JB4表">
        <div class="detailBox">
          <el-form
            :inline="false"
            :model="detailform"
          ...
          >
            ...
            >
              <el-input
                ...
                v-model="detailform.financialDetail.yearstock"/>
            </el-form-item>
            <p  class="detail-title" style="overflow: hidden;margin-right:30px">
              <span>二﹑资产负债</span>
            </p>
            <div class="row-three">
              ...
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.ldasset"/>
              </el-form-item>
              <el-form-item
                label="其中：应收工程款:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.project"/>
              </el-form-item>
              <el-form-item
                label="其中：竣工工程:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.comproject"/>
              </el-form-item>
              <el-form-item
                label="存货:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.stock"/>
              </el-form-item>
            </div>
            <div class="row-three">
              <el-form-item
              ...
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.asset"/>
              </el-form-item>
              <el-form-item
                label="负债合计:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.debt"/>
              </el-form-item>
            </div>
            <p  class="detail-title" style="overflow: hidden;margin-right:30px">
              <span>三﹑损益及分配</span>
            ...
            <div class="row-three">
              ...
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.income"/>
              </el-form-item>
              <el-form-item
                label="其中：主营业务收入:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.mainincome"/>
              </el-form-item>
              <el-form-item
                label="营业成本:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.cost"/>
              </el-form-item>
              <el-form-item
                label="其中：主营业务成本:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.maincost"/>
              </el-form-item>
              <el-form-item
                label="营业税金及附加:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.tax"/>
              </el-form-item>
              <el-form-item
                label="其中：主营业务税金及附加:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.maintax"/>
              </el-form-item>
              <el-form-item
                label="其他业务利润:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.other"/>
              </el-form-item>
              <el-form-item
                label="利润总额:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.sumprofit"/>
              </el-form-item>
            </div>
            <div class="row-three">
              <el-form-item
              ...
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.sale"/>
              </el-form-item>
              <el-form-item
                label="管理费用:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.manage"/>
              </el-form-item>
              <el-form-item
                label="其中：税金:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.taxmanage"/>
              </el-form-item>
              <el-form-item
                label="差旅费:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.clmanage"/>
              </el-form-item>
              <el-form-item
                label="工会经费:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.ghmanage"/>
              </el-form-item>
              <el-form-item
                label="财务费用:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.financial"/>
              </el-form-item>
              <el-form-item
                label="营业利润:"
              >
                <el-input
                  ...
                  v-model="detailform.financialDetail.profit"/>
              </el-form-item>
            </div>
            <p  class="detail-title" style="overflow: hidden;margin-right:30px">
                <span>四、人工成本</span>
            ...
            <el-form-item
              label="应付职工薪酬(本年贷方累计发生额):"
            >
              <el-input
                :disabled="p.actpoint === 'look'||p.actpoint=='task'"
                clearable

                v-model="detailform.financialDetail.salary"/>
            </el-form-item>
            <p  class="detail-title" style="overflow: hidden;margin-right:30px">
                <span>五、土地和固定资产支出: <el-input
                  :disabled="p.actpoint === 'look'||p.actpoint=='task'"
                  clearable

                  v-model="detailform.financialDetail.fixed"/> </span>
            </p>
          </el-form>
        </div>
      </el-tab-pane>
...
<script>
  ...
  import financeDetail from "../project/change/financeDetail";
  export default {
    // name: "详情",
    data() {
    ...
    methods: {
      ...
      saveInfo(formName,type) {
        var url='';
        if(type=='save'){
          url="/api/statistics/Season/detail/save"
        }else{
