    ...
    <div style="width: 100%; overflow: hidden">
      <el-form class="search-form" :inline="true" :model="searchform" @keyup.enter.native="init()">
        ...
        <el-form-item label="项目类型:">
          <el-select v-model="searchform.fillDate" placeholder="请选择">
            <el-option label="全部" value="全部"></el-option>
            <el-option label="自揽" value="自揽"></el-option>
            <el-option label="工区" value="工区"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div style="float: right">
        ...
        <el-button @click="batchT"
                   type="primary" plain><i class="el-icon-thumb"></i>自揽项目批量填0计划</el-button>
