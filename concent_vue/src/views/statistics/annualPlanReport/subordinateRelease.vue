...
<template>
  <div>
    <!--<div style="width: 100%; overflow: hidden">-->
     ...
     <!--&lt;!&ndash;   <el-button @click="searchformSubmit"-->
                   <!--type="primary" plain>查询</el-button>&ndash;&gt;-->
        <!--<el-button @click="add"-->
      ...
      <!--&lt;!&ndash;  <el-button @click="searchformReset"-->
                   <!--type="info" plain-->
      ...
      <!--&lt;!&ndash;<div style="float: right;">&ndash;&gt;-->
        <!--&lt;!&ndash;<el-button @click="searchformSubmit"&ndash;&gt;-->
                   <!--&lt;!&ndash;type="primary" plain><i class="el-icon-search"></i>查询</el-button>&ndash;&gt;-->
      <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--</div>-->
