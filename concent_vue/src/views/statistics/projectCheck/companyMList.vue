...
<script>
  ...
  /*    rowShow(row) {
      ...
      edit() {
        ...
        if((this.multipleSelection[0].flowStatus!=''||this.multipleSelection[0].flowStatus!=null)&& (this.multipleSelection[0].flowStatus=='check'|| this.multipleSelection[0].flowStatus=='pass')){
          ...
          if((this.multipleSelection[0].flowStatus==''||this.multipleSelection[0].flowStatus==null) && (this.multipleSelection[0].projectId!=''||this.multipleSelection[0].projectId!=null)){
            ...
            let p = {selfPath:'../companyMList',fromDate:this.searchform.yearDateS,actpoint:'edit',projectId:JSON.parse(JSON.stringify(this.multipleSelection[0])).projectId,uuid:JSON.parse(JSON.stringify(this.multipleSelection[0])).projectCheckUuid,
