  ...
  <div style="position: relative">
    <el-button @click="back" class="detail-back-tab">返回</el-button>
      ...
      <el-tab-pane
          ...
          :label="index == 0?'工业制造项目(主)':index == detailForm.project.length-1?'工业制造项目(合并后)':'工业制造项目(辅)'"
          :key="index"
        >
      <div class="detailBox">
        <el-form
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <el-input
                ...
                placeholder="请输入"
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                v-model="item.contractAmountSupplement">
                <template slot="prepend">¥</template>
                <template slot="append">(万元)</template>
              </el-input>
            </el-form-item> -->
          ...
          <el-row>
            <el-form-item
              ...
              <el-select
                ...
                placeholder="请选择"
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                @change="getName(item.projectStatusId, projectStatus, 'projectStatusName')"
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <el-input
                ...
                disabled
                placeholder="请输入"
                v-model="item.companyBelongName"/>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item
              ...
              <el-select
                ...
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                placeholder="请选择"
                @change="getName(item.categorySecondId, bizTypeCodeTwo, 'categorySecondName')"
            ...
            <el-form-item
              ...
              <el-input
                ...
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                placeholder="请输入"
                v-model="item.ocontractAmountTotal">
                <template slot="prepend">¥</template>
                <template slot="append">(万元)</template>
              </el-input>
            </el-form-item>
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <!-- <el-select
                ...
                placeholder="请选择"
                @change="getName(item.marketSecondId, emergingMarketTwo, 'marketSecondName')"
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <el-select
                ...
                filterable
                clearable
                @change="getName(item.assemblyTypeId, assemblyType, 'assemblyTypeName')"
                placeholder="请选择"
          ...
          <el-row>
            <el-form-item
              ...
              <el-select
                ...
                filterable
                clearable
                @change="getName(item.architectureTypeId, architecturalType, 'architectureTypeName')"
                placeholder="请选择"
            ...
            <el-form-item
              ...
              <el-select
                ...
                filterable
                clearable
                @change="getName(item.houseTypeId, buildingStructure, 'houseTypeName')"
                placeholder="请选择"
          ...
          <el-row>
            ...
            <!-- <el-form-item
              ...
              <el-input
                ...
                placeholder="请输入"
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                v-model="item.projectPusherPhone"/>
            </el-form-item> -->
          </el-row>
          <!--备注(最多2000字)-->
          <el-row>
            ...
            >
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-link
                    :underline="false"
                    @click="del(scope.$index,scope.row,item.infoProductList)"
                    type="warning">删除
                  </el-link>
                </template>
              </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getBdNameSel(){
        this.cpSelList=[];
        this.detailForm.project.infoProductList.forEach((item)=>{
          this.cpSelList.push(item.productName)
        });
      },
      //产品名称下拉
      getProductData() {
      ...
      getNameTable(id,list,index){
        ...
        this.detailForm.project.infoProductList[index].productTypeName= list.find(
          (item) => item.id === id
        ).productTypeName;
        this.detailForm.project.infoProductList[index].businessCategory= list.find(
          (item) => item.id === id
        ).ywtypename;
