  ...
  <div style="position: relative">
    <el-button @click="back" class="detail-back-tab">返回</el-button>
      ...
      <el-tab-pane
          ...
          :label="index == 0?'其他项目(主)':index == detailForm.project.length-1?'其他项目(合并后)':'其他项目(辅)'"
          :key="index"
        >
      <div class="detailBox">
        <el-form
          ...
          <el-row>
            <el-form-item
              ...
              <el-select
                ...
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                placeholder="请选择"
                @change="getName(item.categoryFirstId, other, 'categoryFirstName')"
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <el-switch
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                class="inline-formitem-switch"
                v-model="item.reportOutputValue"
                active-color="#409EFF"
                inactive-color="#ddd"
                :active-value=0
                :inactive-value=1
