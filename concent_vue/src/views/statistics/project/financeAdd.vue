...
<template>
  <div style="position: relative">
    ...
    <el-button v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailForm.project.flowStatus=='notpass'||detailForm.project.flowStatus=='check')" @click="submitForm('detailForm','sub')"  class="detailbutton detail-back-tab sub-btn">提交
    </el-button>
    <el-button
          ...
          <el-row>
            ...
            <el-form-item
              ...
              <el-input
                ...
                placeholder="请输入"
                :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                v-model="detailForm.project.otherPartyName"/>
            </el-form-item>
            <el-form-item
              label="是否海外合同:"
