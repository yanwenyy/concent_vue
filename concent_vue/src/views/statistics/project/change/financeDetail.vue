          ...
          <el-form
            ...
            <el-row>
              ...
              <el-form-item
                ...
                <el-date-picker
                  :disabled="p.actpoint === 'look'||p.actpoint === 'task'"
                  v-model="detailForm.project.contractValidity"
                  type="date"
                  value-format="timestamp"
                  placeholder="选择日期时间"/>
              </el-form-item>
            ...
            <el-row>
              ...
              <el-form-item
                ...
                <el-select
                  filterable
                  clearable
                  :disabled="p.actpoint === 'look'||p.actpoint === 'task'||detailForm.project.contractInfoList!=''||detailForm.project.marketFirstId==='00b87acd71784c3ba860b9513789724e'"
                  placeholder="请选择"
          ...
          <el-form
            ...
            <el-row>
              ...
              <!-- <el-form-item
                ...
                <el-input
                  ...
                  placeholder="请输入"
                  disabled
                  v-model="showDetailForm.project.otherPartyName"/>
              </el-form-item> -->
              <el-form-item
                label="是否海外合同:"
                prop="isOverseasContract"
            ...
            <el-row>
              ...
              <el-form-item
                ...
                <el-date-picker
                  disabled
                  v-model="showDetailForm.project.contractValidity"
                  type="date"
                  value-format="timestamp"
                  placeholder="选择日期时间"/>
              </el-form-item>
          ...
          <el-form ref="form" label-width="80px">
            <el-form-item>
              <el-checkbox-group v-model="type[index].projectContractField.checkGroup">
                ...
                <el-checkbox label="businsessCategory" name="type">业务类别</el-checkbox>
                <el-checkbox label="topInfoSiteList" name="type">项目地点</el-checkbox>
                <el-checkbox label="contractValidity" name="type">合同有效期</el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-form>
        </el-tab-pane>
