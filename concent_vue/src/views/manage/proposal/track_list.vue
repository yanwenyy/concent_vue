  ...
  <div>
    <div style="width: 100%; overflow: hidden">
      <el-button-group style="float: left">
        ...
        <el-button @click="add('fq')" :disabled="trackStatus=='10'&&flowStatus!='pass'" plain type="primary"><i class="el-icon-warning-outline"></i>放弃跟踪</el-button>
        ...
        this.multipleSelection.forEach((item) => {
          if(item.flowStatus=='edit'||item.flowStatus=='reject'){
           var v={
             ...
             businessType:'contract_project_new'
           }
            list.push(v);
          }else{
