<template>
  <div style="position: relative">
    ...
    <el-button v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailform.topInfoOrg.flowStatus=='notpass'||detailform.topInfoOrg.flowStatus=='check')" @click="submit('detailform','sub')" class="detailbutton detail-back-tab sub-btn">提交</el-button>
