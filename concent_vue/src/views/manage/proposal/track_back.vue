  ...
  <div>
    <div style="width: 100%; overflow: hidden">
      <el-button-group style="float: left">
        <el-button @click="restore" type="primary" plain><i class="el-icon-plus"></i>恢复跟踪</el-button>
      </el-button-group>
  ...
  export default {
    ...
    methods: {
      ...
      restore() {
        ...
        this.$confirm(`确认恢复跟踪数据吗?`, '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
          this.$http.post("/api/contract/topInfo/TopInfor/detail/recoverStatus",{ids: uuids}).then((res) => {
            this.getData()
          });
        }).catch(() => {})
      ...
      getData() {
        this.$http
          .post(
            "/api/contract/topInfo/TopInfor/list/loadPageDataTrackHistory",
            this.searchform
          )
          .then((res) => {
