<template>
  <div style="position: relative">
    <el-button v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailform.topInfor.flowStatus=='edit'||detailform.topInfor.flowStatus=='reject')" @click="saveInfo('detailform','sub')" class="detailbutton detail-back-tab sub-btn">提交</el-button>
    ...
    <el-tabs type="border-card" v-model="activeName">
      ...
      <el-tab-pane label="审批流程" name="lc" v-if="p.actpoint == 'task'||p.actpoint == 'look'&&detailform.topInfor.flowStatus!='edit'&&detailform.topInfor.flowStatus!=null">
