  ...
  <div>
    <div style="width: 100%;overflow: hidden;">
      <el-button-group style="float: left">
        <el-button type="primary" @click="addk" plain :disabled="bidFlowStatus==2||bidFlowStatus==3||flowStatus=='notpass'"><i class="el-icon-document-checked"></i>开标登记</el-button>
      ...
      batchSub(){
        ...
        this.multipleSelection.forEach((item) => {
          if(item.bidFlowStatus==1||item.bidFlowStatus==4){
            var v={
              businessId:item.uuid+'-kb',
              businessName:item.inforName,
              businessType:'contract_bid_register'
            }
            list.push(v);
          }else{
