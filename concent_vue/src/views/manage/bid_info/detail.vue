<template>
  <div  style="position: relative">
      <div slot="header" class="clearfix">
        ...
        >
        <el-button
        v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailform.bidInfo.flowStatus=='notpass'||detailform.bidInfo.flowStatus=='check'||detailform.bidInfo.bidFlowStatus==1||detailform.bidInfo.bidFlowStatus==4)"
