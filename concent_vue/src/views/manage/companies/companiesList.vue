          ...
          <div style="height: calc(100% - 50px);overflow: auto;padding: 0 50px;">
            <el-form
              ...
              <el-form-item
                ...
                class="list-item"
              >
                <el-input v-model="detailForm.companies.companyName" placeholder="单位名称" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <el-form-item label="单位简称:" class="list-item">
                <el-input v-model="detailForm.companies.companyOmit" placeholder="单位简称" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <el-form-item label="统一社会信用代码/组织机构代码:" class="list-item">
                <el-input v-model="detailForm.companies.socialCreditCode" placeholder="统一社会信用代码/组织机构代码" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <br>
              <el-form-item label="法定代表人:" class="list-item">
                <el-input v-model="detailForm.companies.legalRepresentatice" placeholder="法定代表人" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <el-form-item label="注册资本:" class="list-item">
                <el-input v-model="detailForm.companies.registerCapital" placeholder="注册资本" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              ...
              <el-form-item label="企业性质:" class="list-item" >
                <template slot-scope="scope">
                  <el-select
                    clearable
                    placeholder="企业性质"
              ...
              <el-form-item label="企业详细地址:" class="list-item">
                <el-input v-model="detailForm.companies.companyLocationDetail" placeholder="企业详细地址" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <br>

              <el-form-item label="官网链接:" class="list-item" :rules="rules.linkWebsite"  prop="companies.linkWebsite">
                <el-input v-model="detailForm.companies.linkWebsite" placeholder="官网链接" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <el-form-item label="上级单位名称:" class="list-item">
                <el-input v-model="detailForm.companies.superCompanyName" placeholder="上级单位名称" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <el-form-item label="上级单位统一社会信用代码/组织机构代码:" class="list-item">
                <el-input v-model="detailForm.companies.superSocialCreditCode" placeholder="上级单位统一社会信用代码/组织机构代码" clearable :disabled="type === 'look'"></el-input>
              </el-form-item>
              <br>

              <el-form-item label="上级单位官网链接:" class="list-item" :rules="rules.linkWebsite"  prop="companies.superLinkWebsite">
                <el-input v-model="detailForm.companies.superLinkWebsite" placeholder="上级单位官网链接" clearable :disabled="type === 'look'"></el-input>
              </el-form-item><br>
