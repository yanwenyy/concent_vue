<template>
  <div style="position: relative">
    ...
    <el-button v-show="p.actpoint != 'look'&&p.actpoint != 'task'&&(p.actpoint == 'add'||detailform.contractInfo.flowStatus=='notpass'||detailform.contractInfo.flowStatus=='check')" @click="saveInfo('detailform','sub')" class="detailbutton detail-back-tab sub-btn">提交</el-button>
          ...
          <el-tabs type="border-card">
            <el-tab-pane label="工业制造合同">
                <div class="detailBoxBG">
                  ...
                  >
                    <el-input
                      disabled
                      size="mini"
                      v-model="detailFormBefore.contractInfo.industryProduceNu"
                    />
                  </el-form-item>
                  <br>
                  <el-form-item
                  ...
                  >
                    <el-date-picker
                      ...
                      type="date"
                      value-format="timestamp"
                      v-model="detailFormBefore.contractInfo.contractStartTime"
                  ...
                  >
                    <el-date-picker
                      ...
                      type="date"
                      value-format="timestamp"
                      v-model="detailFormBefore.contractInfo.contractEndTime"
                  ...
                  >
                    <el-input
                      ...
                      placeholder=""
                      size="mini"
                      v-model="detailFormBefore.contractInfo.extendAmount"
                    >
                      <template slot="prepend">¥</template>
                      <template slot="append">(万元)</template>
                    </el-input>
                  ...
                  >
                    <el-input
                      disabled
                      size="mini"
                      v-model="detailFormBefore.contractInfo.industryOverseasContract"
                    />
                  </el-form-item>
                  <br>
                  <el-form-item
                  ...
                  >
                    <el-switch
                      disabled
                      class="inline-formitem-switch"
                      v-model="detailFormBefore.contractInfo.isSystemPurchaseIndustry"
                      active-color="#409EFF"
                      inactive-color="#ddd"
                      active-value="0"
                      inactive-value="1"
                  ...
                  >
                    <el-switch
                      disabled
                      class="inline-formitem-switch"
                      v-model="detailFormBefore.contractInfo.isAreaTakeIndustry"
                      active-color="#409EFF"
                      inactive-color="#ddd"
                      active-value="0"
                      inactive-value="1"
                  ...
                  >
                    <el-input
                      ...
                      v-model="detailFormBefore.contractInfo.productTypeName"
                    />
                  </el-form-item>
                  <el-form-item
                ...
                color: 'rgba(0,0,0,1)',
                  ...
                  <el-table
                    :data="detailFormBefore.contractInfoProductInformtList"
                    :header-cell-style="{'text-align' : 'center','background-color' : 'rgba(246,248,252,1)','color':'rgba(0,0,0,1)'}"
                    @selection-change="handleSelectionChange"
                    align="center"
                    border
                  ...
                  >
                    ...
                    <el-table-column width="150" align="center"  class="listTabel" :resizable="false" label="产品类型" prop="productTypeName" show-overflow-tooltip>
                    ...
                    <el-table-column align="center" :resizable="false" label="规格型号" prop="specificationAndModel" show-overflow-tooltip>

                    </el-table-column>

                    <el-table-column align="center" :resizable="false" label="产品数量" prop="productQuantity" show-overflow-tooltip>

                    </el-table-column>


                    <el-table-column align="center" :resizable="false" label="产品单位" prop="productUnit" show-overflow-tooltip>

                    </el-table-column>

                    <el-table-column align="center" :resizable="false" label="总价(万元)" prop="productTotalPrice" show-overflow-tooltip>
                ...
                >
                  ...
                  <el-table-column width="150"  class="listTabel" :resizable="false" label="产品类型" prop="productId" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <el-form-item
                        class="tabelForm"
                        :prop="'contractInfoProductInformtList.'+scope.$index+'.productTypeId'"
                        :rules="{
      required: true, message: '此项不能为空', trigger: 'blur'
    }"
                        label-width="0"
                      >
                        <el-select
                          ...
                          @change="getcpxx(scope.row.productTypeId,detailform.contractInfoProductInformtList,scope.$index)"
  ...
  export default {
    ...
    methods: {
      ...
      saveInfo(formName,type) {
        ...
        if(this.detailform.contractInfo.contractEndTime<this.detailform.contractInfo.contractStartTime){
          this.$message.error("合同结束日期不能小于合同开始日期");
          return false;
        }
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var datas=this.p.actpoint === "add"||(type!='save'&&this.detailform.contractInfo.flowStatus=='notpass'||this.detailform.contractInfo.flowStatus=='check')?{
      ...
      getDetail() {
        ...
        this.detailform={
          ...
          contractInfoProductInformtList: afterData.contractInfoProductInformtList,
          zplx:[],//装配类型
          jzlx:[],//建筑类型
          jzjglx:[],//建筑结构类型
          cdmc:[],//场地名称
