    ...
    >
      ...
      required: true, message: '此项不能为空', trigger: 'blur'
              ...
              >
                ...
                <!--/>-->
                <el-input :disabled="p.actpoint === 'look'||p.actpoint=='task'||p.actpoint=='Yjedit'||p.pushId||p.type == 'bq'" placeholder="请输入内容" v-model="detailform.contractInfo.contractName" class="input-with-select">
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    ...
                    <el-link v-if="p.actpoint!=='look'&&p.actpoint!='Yjedit'&&p.actpoint!='task'" :underline="false" @click="handleRemove1(scope.row,scope.$index)" type="warning">删除</el-link>
                  </template>
                </el-table-column>
              </el-table>
              <p><span >招标公告文件: </span>
