<template>
  <div>
        ...
        <span style="color: #2a2a7d"><b>工程承包合同</b></span>
    ...
    <el-row>
     ...
     <p style="overflow:hidden;"><span style="float:left;">中标通知书(最大10MB): </span>   <el-button
            @click="show('add')"
            size="mini"
            style="float:left;width: 100px;height: 32px;background: #5C8BFA;font-size: 16px;"
            type="primary"
          >增加文件</el-button> </p>
        ...
        <p style="overflow:hidden;"><span style="float:left;">合同附件(最大10MB): </span>   <el-button
            @click="show('add')"
            size="mini"
            style="float:left;width: 100px;height: 32px;background: #5C8BFA;font-size: 16px;"
            type="primary"
        ...
        <p style="overflow:hidden;"><span style="float:left;">工程量清单和劳材机附件(两种文件都要)(最大10MB): </span>   <el-button
            @click="show('add')"
            size="mini"
            style="float:left;width: 100px;height: 32px;background: #5C8BFA;font-size: 16px;"
            type="primary"
     ...
     <p style="overflow:hidden;">
       <span style="float:left;">标段信息: </span>
        ...
        ></el-table-column>
          ...
          <el-table-column :resizable="false" label="风险费(万元)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="安全费(万元)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="投标限价(万元)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="投标保证金(万元)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="投标价(万元)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="投标费率(百分比)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="开标地点" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="评标办法" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="开标日期" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="其他投标单位(系统内)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="其他投标单位(系统外)" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="其他未列单位" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="项目经理" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="项目副经理" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="技术负责人" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="安全负责人" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="财务负责人" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
          ...
          <el-table-column :resizable="false" label="成本负责人" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
