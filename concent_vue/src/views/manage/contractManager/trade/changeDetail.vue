    ...
    <el-tabs type="border-card">
                ...
                <div class="detailBoxBG">
                  ...
                  >
                    <el-input
                      disabled
                      size="mini"
                      v-model="detailFormBefore.contractInfo.isYearContract==='0'?'是':'否'"
                    />
                  </el-form-item>
                  <el-form-item
                    label="录入单位:"
           ...
           required: true, message: '此项不能为空', trigger: 'blur'
                ...
                >
                  <el-select
                    ...
                    @change="ifYearHt(detailform.contractInfo.isYearContract)"
                  >
                    <el-option :key="index" :label="item.detailName" :value="item.id" v-for="(item,index) in yesOrNo"></el-option>
                  </el-select>
                </el-form-item>
      ...
      required: true, message: '此项不能为空', trigger: 'blur'
                ...
                >
                  ...
                  <el-table-column :resizable="false" label="总价(万元)" prop="totalPrice" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <el-form-item
                        class="tabelformItem"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-link  v-show="!scope.row.uuid" :underline="false" @click="del(scope.$index,scope.row,detailform.contractInfoSubjectMatterList,'bdw')" type="warning">删除</el-link>
                    </template>
                  </el-table-column>
                </el-table>
