  ...
  export default {
    ...
    methods: {
      ...
      getOurAmount(index,list){
        ...
        if(this.detailform.contractInfo.contractAmount-money>0){
          this.detailform.contractInfo.ourAmount=this.detailform.contractInfo.contractAmount-money;
          console.log(this.detailform.contractInfo.ourAmount)
        }else if(index){
