        ...
        <el-tab-pane label="勘察设计合同">
            <div class="detailBoxBG">
              ...
              <el-form-item
                ...
                prop="contractInfo.contractName"
              >
                <el-input :disabled="p.actpoint === 'look'||p.actpoint=='task'||p.pushId||p.actpoint=='Yjedit'" placeholder="请输入内容" v-model="detailform.contractInfo.contractNameForeign" class="input-with-select">
                ...
                >
                  ...
                  >
                    <template slot-scope="scope">
                      ...
                      <el-link v-show="p.actpoint!=='look'&&p.actpoint!=='task'" :underline="false" @click="handleRemove1(scope.row,scope.$index)" type="warning">删除</el-link>
                    </template>
                  </el-table-column>
                </el-table>
              <p>
    ...
    methods: {
     ...
     //建设单位下拉赋值
        ...
        if(this.detailform.contractInfo.contractAmount>0){
          if(type=='wlht'||type=='nlht' ){
            ...
            if(this.detailform.contractInfo.unAllocatedFee&&jtnfbTotal>this.detailform.contractInfo.contractAmount-(this.detailform.contractInfo.unAllocatedFee)){
              ...
              var zile=Number((this.detailform.contractInfo.ourAmount||0)-(this.detailform.contractInfo.unAllocatedFee||0)-our_money)
              // console.info(this.detailform.contractInfo.projectNatureFirstId,this.detailform.contractInfo.ourAmount,this.detailform.contractInfo.unAllocatedFee,our_money)
              if(zile<0){
      ...
      saveInfo(formName,type) {
        ...
        if(this.detailform.contractInfo.isOpenBid=='1'&&this.detailform.fileList3.length==0){
