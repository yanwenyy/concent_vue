<template>
  <div>
        ...
        <span style="color: #2a2a7d"><b>勘察设计合同新增</b></span>
...
<el-row>
  ...
  <el-button
        ...
        <el-table-column
          ...
          type="index"><el-checkbox v-model="checked"></el-checkbox></el-table-column>
 ...
 <el-table-column :resizable="false" label="参与投标单位" prop="part" show-overflow-tooltip>
      ...
      required: true, message: '此项不能为空', trigger: 'blur'
          ...
          <el-table-column :resizable="false" label="其他未列出单位" prop="part" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item
                :prop="'clothSizePartList.'+scope.$index+'.part'"
                :rules="{
